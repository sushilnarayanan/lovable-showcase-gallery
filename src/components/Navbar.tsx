      ...
      <div className="flex items-center justify-between py-4 px-6 md:px-16 lg:px-24">
        <div className="flex items-center space-x-8">
          <Link to="/" className="h-8">
            <span className="text-netflix-red text-3xl font-bold tracking-tighter">NETFLIX</span>
          </Link>
          <nav className="hidden md:flex">
            <ul className="flex space-x-6">
              <li><Link to="/" className="text-sm text-white hover:text-gray-300 font-medium">Home</Link></li>
        ...
        <div className="flex items-center space-x-5">
          ...
          <div className="w-8 h-8 bg-slate-600 rounded flex items-center justify-center cursor-pointer">
